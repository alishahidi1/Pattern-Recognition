...
#Constructing the decision tree based on Information Gain...
#... and calculating average accuracy, variance, and Confusion Matrix:

#Tic-Toc-Toe:
#Runing 10-times-10-fold Cross Validation
y=k_fold_t_times(ds,k=10,t=10,bss=0)

print('For Tic-Toc-Toe dataset, Based on Information Gain:')

#Average accuracy (%)
print('\nAverage Accuracy =',y[0],'%')

#Variance
print('\nVariance =',y[1])

#Confusion Matrix
print('\nConfusion Matrix of the Best Accuracy =\n',y[2])
print('\nBest Accuracy =',y[3])
print('-------------------------------')

#Wine:
#Runing 10-times-10-fold Cross Validation
y=k_fold_t_times_c(dc,k=10,t=10,bss=0)

print('For Wine dataset, Based on Information Gain:')
...
#Constructing the decision tree based on Gain Ratio...
#... and calculating average accuracy, variance, and Confusion Matrix:

#Tic-Toc-Toe:
#Runing 10-times-10-fold Cross Validation
y=k_fold_t_times(ds,k=10,t=10,bss=1)

print('For Tic-Toc-Toe dataset, Based on Gain Ratio:')
...
#Wine:
#Runing 10-times-10-fold Cross Validation
y=k_fold_t_times_c(dc,k=10,t=10,bss=1)

print('For Wine dataset, Based on Gain Ratio:')
